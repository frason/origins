...
---
**Updated planning pass 71 (2026-08-31):** #165's original scope was too large for a single
worker run (4 straight failed commit attempts, same root-cause pattern #164 needed 7 rounds and
a scope-narrowing to fix). Split #165 down to just trait-frequency tracking/storage, with the
evidence-labeling/classification piece spun out to #276 and the timeline/lineage/journal UI
wiring to #277. Both added below so this epic doesn't get marked complete until the full
original #165 scope actually lands.

depends_on: #165, #166, #167, #168, #276, #277
